...
public abstract class JsonRpcClient implements JsonRpcRequestSender, Closeable {
     ...
     *
     * @param mayInterruptIfRunning Signals the task to interrupt even if it is already running
     */
     ...
     *
     * @throws IOException if an I/O error occurs when closing this client.
     */
    @Override
