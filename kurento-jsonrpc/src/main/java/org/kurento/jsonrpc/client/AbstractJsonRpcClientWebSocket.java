...
public abstract class AbstractJsonRpcClientWebSocket extends JsonRpcClient {
    ...
    protected <P, R> Response<R> internalSendRequestWebSocket(Request<P> request,
        ...
        System.out.println("SendRequest : " + jsonMessage);

        sendTextMessage(jsonMessage);

        if (responseFuture == null) {
            System.out.println("SendRequest : responseFuture == null");
            return null;
        }
        ...
        try {
            ...
            System.out.println("SendRequest : got : " + responseJson.toString());
    ...
    protected void connectIfNecessary() throws IOException {
        try {
            if (!isNativeClientConnected() && connectNativeClient()) {
                updateSession();
            }
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    protected abstract boolean connectNativeClient() throws InterruptedException;
